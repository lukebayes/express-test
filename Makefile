###########################################################
# Express Test Helper build script
###########################################################
...
dist/express-test.js: index.js src/*
	$(WEBPACK) --config $(WEBPACK_CLIENT_CONFIG) index.js dist/express-test.js
